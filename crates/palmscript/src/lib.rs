...
pub use backtest::{
    ...
    GateUsdtPerpsRiskSnapshot, GateUsdtPerpsRiskSource, HyperliquidPerpsRiskSnapshot,
    InputSweepDefinition, MarkPriceBasis, NumericExportDiagnosticSummary, OpportunityEvent,
    ...
    OptimizeResult, OptimizeRunner, OrderDiagnostic, OrderEndReason, OrderRecord, OrderStatus,
    PerpBacktestConfig, PerpBacktestContext, PerpBacktestMetadata, PerpMarginMode,
    PositionSnapshot, RiskTier, SideDiagnosticSummary, Trade, TradeDiagnostic,
    TradeExitClassification, VenueRiskSnapshot, WalkForwardConfig, WalkForwardEquityPoint,
