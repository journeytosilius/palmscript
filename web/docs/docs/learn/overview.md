...
- deterministic overfitting-risk summaries, baseline comparisons, bounded date-perturbation reruns for top-level backtests, and improvement hints that stay conservative when no out-of-sample evidence exists
