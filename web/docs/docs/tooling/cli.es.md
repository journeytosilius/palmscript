...
`experimental/xrp_usdm_mean_reversion.ps`, para que la estrategia avanzada con
varias fuentes y la sesion paper de mean reversion XRP USD-M se ejecuten
juntas por defecto. Las
